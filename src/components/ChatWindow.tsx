      ...
      {messages.length === 0 && !isLoadingMore ? (
        <div className="flex items-center justify-center h-full">
          <div className="text-center animate-float">
            ...
            <div className="text-lg font-semibold text-gray-700 mb-1">No messages yet</div>
            <div className="text-sm text-gray-400">Send a message to start the conversation</div>
          </div>
        </div>
      ) : (
